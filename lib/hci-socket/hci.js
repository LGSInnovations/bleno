...
Hci.prototype.init = function (deviceId, channelUser, advertisementInterval) {
  this._socket.on('data', this.onSocketData.bind(this));
  this._socket.on('error', this.onSocketError.bind(this));

  this._advertisementInterval = advertisementInterval;
...
Hci.prototype.setAdvertisingParameters = function() {
  ...
  // data
  cmd.writeUInt16LE(this._advertisementInterval, 4); // min interval
  cmd.writeUInt16LE(this._advertisementInterval, 6); // max interval
